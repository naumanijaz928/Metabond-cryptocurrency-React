...
///// user Apis
import { addUser } from "../../../../core/utilities/apis/PrivateApis/userApi";
import {
  getCities,
  getCountries,
  getPractices,
...
const AddForm = ({ showModal }) => {
  ...
  const validationSchema = Yup.object({
    ...
    password: Yup.string()
      .min(8, 'minimum 8 digits').required("password is required minimum 8")
  ...
  return (
    <>
      <Typography variant="h5" sx={{ padding: '10px', textAlign: 'center' }}>Add User</Typography>
      <Formik
        initialValues={{
          ...initialValues,
        }}
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  {cities.map((citi) => (
                    <MenuItem key={citi.id} value={citi.id}>
                      {citi.name}
                    </MenuItem>
                  ))}
                </MuiSelect>
